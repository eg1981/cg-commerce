    ...
    <div class="cart-totals">
        <div class="woocommerce-mini-cart__total total">
            ...
            <div class="mini-cart-totals">
                <ul>
                    <li><strong><?php esc_html_e( 'Subtotal:', 'woocommerce' ); ?></strong>
                        <?php wc_cart_totals_subtotal_html(); ?>
                    </li>

                    <?php if ( wc_tax_enabled() && ! WC()->cart->display_prices_including_tax() ) : ?>
                        <li><strong><?php esc_html_e( 'Tax:', 'woocommerce' ); ?></strong>
                            <?php echo wc_price( WC()->cart->get_taxes_total() ); ?>
                        </li>
                    <?php endif; ?>

                    <?php if ( WC()->cart->get_discount_total() > 0 ) : ?>
                        <li><strong><?php esc_html_e( 'Discount:', 'woocommerce' ); ?></strong>
                            <?php echo wc_price( WC()->cart->get_discount_total() ); ?>
                        </li>
                    <?php endif; ?>

                    <?php if ( WC()->cart->get_shipping_total() > 0 ) : ?>
                        <li><strong><?php esc_html_e( 'Shipping:', 'woocommerce' ); ?></strong>
